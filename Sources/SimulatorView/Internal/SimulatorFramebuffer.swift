...
final class SimulatorFramebuffer: @unchecked Sendable {
    enum FramebufferError: Error, CustomStringConvertible {
        ...
        var description: String {
            switch self {
            case .ioUnavailable: return "SimDevice has no `io` (SimDeviceIOClient)."
            case .noFramebuffer: return "No `com.apple.framebuffer.display` port on the device."
            case .callbackUnavailable: return "registerScreenCallbacksWithUUID:… selector missing."
            }
        }
    }
