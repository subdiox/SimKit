...
public enum SimulatorBiometrics: Sendable {
  ...
  @discardableResult
  public static func match(_ kind: Kind, udid: String) async -> Bool {
    await post(udid: udid, name: kind.matchNotification)
  }

  @discardableResult
  public static func nonMatch(_ kind: Kind, udid: String) async -> Bool {
    await post(udid: udid, name: kind.nonMatchNotification)
  }
  ...
  @concurrent
  @discardableResult
  private static func post(udid: String, name: String) async -> Bool {
    let process = Process()
